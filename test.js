...
let defaultDaysData =
    ...
    {'date': '2023-12-22', 'name': '冬至'},
    {'date': '2023-12-25', 'name': '圣诞节'}] // 内置假日
...
$task.fetch(options).then(response => {
    const notifyContent = dateDiffArray[0].name + ":" + today(tnumcount(0)) + "," + dateDiffArray[Number(0) + Number(1)].name + ":" + tnumcount(Number(0) + Number(1)) + "天," + dateDiffArray[Number(0) + Number(2)].name + ":" + tnumcount(Number(0) + Number(2)) + "天"
